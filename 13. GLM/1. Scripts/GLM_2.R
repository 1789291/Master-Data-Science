...
# Un 0.9 de probabilidad es lo mismo que decir 9/1 (o 9). Un 0.50 es una odds de 1. Las odds van que si tengo 0.9, resto 1-0.9 y me da 0.1, 
# y me dice cuántas veces es más grande 0.9 sobre 0.1. En odds la referencia es el 0.5, el 1.
# El coeficiente es el aumento en el odds ratio
